...
public class C04_SmokeTestRaporlu extends TestBaseRapor {
    ...
    public void yanlisPasswordTesti() {
        ...
        Driver.getdriver().get(ConfigReader.getProperty("myUrl"));
        // login linkine basin
        myCoursedemyPage = new MyCoursedemyPage();//normalde burada bunu oluşturmamam gerekiyor cunku yukarıda zaten
        // oluşturmuştum ama driver açılıp kapandıgı için bu  objeleri kayıt etmke de zorlanıyor.
        myCoursedemyPage.cookies.click();
        myCoursedemyPage.loginLinki.click();
